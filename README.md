...
The project was generated using the [Clean.Architecture.Solution.Template](https://github.com/jasontaylordev/CleanArchitecture) version 10.7.2.
...
```bash
dotnet new install Clean.Architecture.Solution.Template::10.7.2
```
